        ...
        {activeSection === 'about' && (
          ...
          <div
            ...
            <div
              ...
              {(() => {
                const toolLogos = [
                  { name: 'Figma', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M15.852 8.981h-4.588V0h4.588c2.476 0 4.49 2.014 4.49 4.49s-2.014 4.491-4.49 4.491zM12.735 7.51h3.117c1.665 0 3.019-1.355 3.019-3.019s-1.354-3.019-3.019-3.019h-3.117V7.51zm0 1.471H8.148c-2.476 0-4.49-2.014-4.49-4.49S5.672 0 8.148 0h4.588v8.981zm-4.587-7.51c-1.665 0-3.019 1.355-3.019 3.019s1.354 3.019 3.019 3.019h3.117V1.471H8.148zm4.587 15.019H8.148c-2.476 0-4.49-2.014-4.49-4.49s2.014-4.49 4.49-4.49h4.588v8.98zM8.148 8.981c-1.665 0-3.019 1.355-3.019 3.019s1.354 3.019 3.019 3.019h3.117V8.981H8.148zM8.172 24c-2.489 0-4.515-2.014-4.515-4.49s2.026-4.49 4.515-4.49c2.489 0 4.515 2.014 4.515 4.49S10.661 24 8.172 24zm0-7.509c-1.665 0-3.019 1.355-3.019 3.019s1.354 3.019 3.019 3.019 3.019-1.355 3.019-3.019-1.354-3.019-3.019-3.019zm7.704 7.509c-2.476 0-4.49-2.014-4.49-4.49v-4.49h4.49c2.476 0 4.49 2.014 4.49 4.49s-2.014 4.49-4.49 4.49zm-3.019-4.49c0 1.665 1.354 3.019 3.019 3.019s3.019-1.355 3.019-3.019-1.354-3.019-3.019-3.019h-3.019v3.019z"/></svg> },
                  ...
                  { name: 'Adobe XD', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M13.966 0h6.64C21.85 0 24 2.142 24 4.785v14.43C24 21.85 21.858 24 19.215 24H13.97V0h-.004zM0 4.786C0 2.142 2.142 0 4.785 0h6.64v24H4.786C2.142 24 0 21.858 0 19.215V4.786zm9.975 5.54L7.704 14.4l2.4 4.33c.044.08.044.175-.007.252-.05.076-.133.12-.22.12H8.252c-.303 0-.582-.162-.73-.424L5.97 15.67l-1.557 3.01c-.15.262-.43.424-.73.424H2.057c-.087 0-.17-.044-.22-.12-.052-.077-.052-.172-.008-.252l2.38-4.247L2.062 10.32c-.044-.08-.044-.175.007-.25.05-.077.135-.12.22-.12h1.55c.297 0 .57.16.716.417l1.425 2.606 1.42-2.61c.148-.255.42-.413.717-.413h1.55c.087 0 .17.043.22.12.052.077.052.17.008.25zm9.247 3.217c0 2.727-1.66 4.383-4.324 4.383-.128 0-.254-.003-.38-.01V9.13c0-.1.08-.18.18-.18h.92c2.36 0 3.604 1.228 3.604 3.593zM14.5 9.13v8.776c1.358-.13 2.39-.594 3.058-1.378.668-.785 1.006-1.894 1.006-3.3 0-1.254-.312-2.263-.928-2.997-.616-.734-1.578-1.1-2.856-1.1h-.28z"/></svg> },
                  ...
                  { name: 'Canva', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.126 15.974c-.162.234-.432.378-.72.378-.168 0-.33-.048-.474-.138-1.11-.696-2.34-1.062-3.654-1.062-1.2 0-2.376.306-3.396.882-.15.084-.318.132-.486.132-.3 0-.582-.15-.75-.402-.246-.378-.144-.882.234-1.128 1.248-.762 2.688-1.164 4.158-1.164 1.62 0 3.18.462 4.5 1.332.378.24.48.738.24 1.17h.348zm1.2-3.204c-.204.294-.534.468-.882.468-.198 0-.396-.054-.57-.162-1.452-.906-3.09-1.386-4.8-1.386-1.596 0-3.15.432-4.5 1.248-.174.108-.372.162-.57.162-.348 0-.684-.174-.882-.468-.306-.486-.162-1.128.318-1.44 1.596-.996 3.42-1.524 5.274-1.524 2.022 0 3.972.582 5.64 1.686.486.306.63.948.318 1.44l.654-.024zm1.224-3.288c-.192.294-.516.468-.858.468-.192 0-.39-.054-.564-.162-1.788-1.11-3.81-1.698-5.886-1.698-1.95 0-3.84.54-5.466 1.56-.174.108-.372.162-.564.162-.342 0-.666-.174-.858-.468-.318-.51-.156-1.17.354-1.488 1.878-1.164 4.026-1.776 6.228-1.776 2.394 0 4.71.672 6.672 1.944.51.318.672.978.354 1.488l.588-.03z"/></svg> },
                ...
                return (
                  <div style={{ position: 'relative', overflow: 'hidden', width: '100%' }}>
                    ...
                    <div style={{ display: 'flex', gap: '2.5rem', width: 'max-content', animation: 'toolMarquee 26s linear infinite' }}>
                      {items.map((tool, i) => (
                        <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.45rem', flexShrink: 0, opacity: 0.6, transition: 'opacity 0.25s ease, transform 0.25s ease', cursor: 'default' }}
                        ...
                        >
                          {tool.svg}
                          <span style={{ fontSize: 'clamp(0.58rem, 1vw, 0.66rem)', color: 'rgba(255,255,255,0.5)', fontFamily: '"Space Mono", monospace', letterSpacing: '0.05em', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>{tool.name}</span>
                        </div>
                      ))}
                    </div>
                  </div>
