    ...
    projects: [
      {
        ...
        year: "2026",
        description: "Understanding your child better",
        color: "#6366F1",
        content: {
      ...
      >
        ...
        {activeSection === 'about' && (
          ...
          <div
            ...
            {/* Software Tools Section — infinite marquee with logos */}
            <div
              data-scroll-id="s28"
              style={{
              marginTop: '1.5rem',
              ...
              {(() => {
                const toolLogos = [
                  { name: 'Figma', svg: <svg viewBox="0 0 38 57" fill="white" width="40" height="40"><path d="M19 28.5a9.5 9.5 0 1 1 19 0 9.5 9.5 0 0 1-19 0z"/><path d="M0 47.5A9.5 9.5 0 0 1 9.5 38H19v9.5a9.5 9.5 0 0 1-19 0z"/><path d="M19 0v19h9.5a9.5 9.5 0 0 0 0-19H19z"/><path d="M0 9.5A9.5 9.5 0 0 0 9.5 19H19V0H9.5A9.5 9.5 0 0 0 0 9.5z"/><path d="M0 28.5A9.5 9.5 0 0 0 9.5 38H19V19H9.5A9.5 9.5 0 0 0 0 28.5z"/></svg> },
                  { name: 'HTML', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/></svg> },
                  { name: 'CSS', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z"/></svg> },
                  { name: 'JavaScript', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M0 0h24v24H0V0zm22.034 18.276c-.175-1.095-.888-2.015-3.003-2.873-.736-.345-1.554-.585-1.797-1.14-.091-.33-.105-.51-.046-.705.15-.646.915-.84 1.515-.66.39.12.75.42.976.9 1.034-.676 1.034-.676 1.755-1.125-.27-.42-.404-.601-.586-.78-.63-.705-1.469-1.065-2.834-1.034l-.705.089c-.676.165-1.32.525-1.71 1.005-1.14 1.291-.811 3.541.569 4.471 1.365 1.02 3.361 1.244 3.616 2.205.24 1.17-.87 1.545-1.966 1.41-.811-.18-1.26-.586-1.755-1.336l-1.83 1.051c.21.48.45.689.81 1.109 1.74 1.756 6.09 1.666 6.871-1.004.029-.09.24-.705.074-1.65l.046.067zm-8.983-7.245h-2.248c0 1.938-.009 3.864-.009 5.805 0 1.232.063 2.363-.138 2.711-.33.689-1.18.601-1.566.48-.396-.196-.597-.466-.83-.855-.063-.105-.11-.196-.127-.196l-1.825 1.125c.305.63.75 1.172 1.324 1.517.855.51 2.004.675 3.207.405.783-.226 1.458-.691 1.811-1.411.51-.93.402-2.07.397-3.346.012-2.054 0-4.109 0-6.179l.004-.056z"/></svg> },
                  { name: 'React', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M14.23 12.004a2.236 2.236 0 0 1-2.235 2.236 2.236 2.236 0 0 1-2.236-2.236 2.236 2.236 0 0 1 2.235-2.236 2.236 2.236 0 0 1 2.236 2.236zm2.648-10.69c-1.346 0-3.107.96-4.888 2.622-1.78-1.653-3.542-2.602-4.887-2.602-.41 0-.783.093-1.106.278-1.375.793-1.683 3.264-.973 6.365C1.98 8.917 0 10.42 0 12.004c0 1.59 1.99 3.097 5.043 4.03-.704 3.113-.39 5.588.988 6.38.32.187.69.275 1.102.275 1.345 0 3.107-.96 4.888-2.624 1.78 1.654 3.542 2.603 4.887 2.603.41 0 .783-.09 1.106-.275 1.374-.792 1.683-3.263.973-6.365C22.02 15.096 24 13.59 24 12.004c0-1.59-1.99-3.097-5.043-4.032.704-3.11.39-5.587-.988-6.38-.318-.184-.688-.277-1.092-.278zm-.005 1.09c.225 0 .406.044.558.127.666.382.955 1.835.73 3.704-.054.46-.142.945-.25 1.44-.96-.236-2.006-.417-3.107-.534-.66-.905-1.345-1.727-2.035-2.447 1.592-1.48 3.087-2.292 4.105-2.29zm-9.77.02c1.012 0 2.514.808 4.11 2.28-.686.72-1.37 1.537-2.02 2.442-1.107.117-2.154.298-3.113.538-.112-.49-.195-.964-.254-1.42-.23-1.868.054-3.32.714-3.707.19-.09.4-.127.563-.132zm4.882 3.05c.455.468.91.992 1.36 1.564-.44-.02-.89-.034-1.36-.034-.47 0-.92.014-1.36.034.44-.572.895-1.096 1.36-1.565zM12 8.1c.74 0 1.477.034 2.202.093.406.582.802 1.203 1.183 1.86.372.64.71 1.29 1.018 1.946-.308.655-.646 1.31-1.013 1.95-.38.66-.773 1.288-1.18 1.87-.728.063-1.466.098-2.21.098-.74 0-1.477-.035-2.202-.093-.406-.582-.802-1.204-1.183-1.86-.372-.64-.71-1.29-1.018-1.946.303-.657.646-1.313 1.013-1.954.38-.66.773-1.286 1.18-1.868.728-.064 1.466-.098 2.21-.098zm-3.635.254c-.24.377-.48.763-.704 1.16-.225.39-.435.782-.635 1.174-.265-.656-.49-1.31-.676-1.947.64-.15 1.315-.283 2.015-.386zm7.26 0c.695.103 1.365.23 2.006.387-.18.632-.405 1.282-.66 1.933-.2-.39-.41-.783-.64-1.174-.225-.392-.465-.774-.705-1.146zm3.063.675c.484.15.944.317 1.375.498 1.732.74 2.852 1.708 2.852 2.476-.005.768-1.125 1.74-2.857 2.475-.42.18-.88.342-1.355.493-.28-.958-.646-1.956-1.1-2.98.45-1.017.81-2.01 1.085-2.964zm-13.395.004c.278.96.645 1.957 1.1 2.98-.45 1.017-.812 2.01-1.086 2.964-.484-.15-.944-.318-1.37-.5-1.732-.737-2.852-1.706-2.852-2.474 0-.768 1.12-1.742 2.852-2.476.42-.18.88-.342 1.356-.494zm11.678 4.28c.265.657.49 1.312.676 1.948-.64.157-1.316.29-2.016.39.24-.375.48-.762.705-1.158.225-.39.435-.785.636-1.18zm-9.945.02c.2.392.41.783.64 1.175.23.39.465.772.705 1.143-.695-.102-1.365-.23-2.006-.386.18-.63.406-1.282.66-1.933zM17.92 16.32c.112.493.2.968.254 1.423.23 1.868-.054 3.32-.714 3.708-.147.09-.338.128-.563.128-1.012 0-2.514-.807-4.11-2.28.686-.72 1.37-1.536 2.02-2.44 1.107-.118 2.154-.3 3.113-.54zm-11.83.01c.96.234 2.006.415 3.107.532.66.905 1.345 1.727 2.035 2.446-1.595 1.483-3.092 2.295-4.11 2.295-.22-.005-.406-.05-.553-.132-.666-.38-.955-1.834-.73-3.703.054-.46.142-.944.25-1.438zm4.56.64c.44.02.89.034 1.36.034.47 0 .92-.014 1.36-.034-.44.572-.895 1.095-1.36 1.565-.455-.47-.91-.993-1.36-1.565z"/></svg> },
                  { name: 'Adobe XD', svg: <svg viewBox="0 0 40 40" fill="none" width="40" height="40"><rect width="40" height="40" rx="8" fill="rgba(255,255,255,0.1)"/><text x="50%" y="52%" dominantBaseline="central" textAnchor="middle" fill="white" fontSize="13" fontFamily="Arial Black, sans-serif" fontWeight="900" letterSpacing="0.5">Xd</text></svg> },
                  { name: 'GitHub', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg> },
                  { name: 'Canva', svg: <svg viewBox="0 0 40 40" fill="none" width="40" height="40"><rect width="40" height="40" rx="10" fill="rgba(255,255,255,0.1)"/><text x="50%" y="50%" dominantBaseline="central" textAnchor="middle" fill="white" fontSize="22" fontFamily="Arial Black, sans-serif" fontWeight="900">C</text></svg> },
                  { name: 'Webflow', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M17.803 7.573s-2.297 7.02-2.4 7.37c-.034-.367-.924-7.37-.924-7.37H11.26s-2.34 7.125-2.43 7.44c-.022-.34-.876-7.44-.876-7.44H4.898L7.142 18.63h3.14l2.57-7.244 2.575 7.244h3.142L21.1 7.573h-3.297z"/></svg> },
                  { name: 'Midjourney', svg: <svg viewBox="0 0 24 24" fill="white" width="28" height="28"><path d="M3.5 3.5C4.76 2.24 6.29 1.5 8 1.5c1.71 0 3.24.74 4.5 2 .48.48.9 1.02 1.25 1.6.35-.58.77-1.12 1.25-1.6C16.26 2.24 17.79 1.5 19.5 1.5c1.71 0 3.24.74 4.5 2l-1.06 1.06C21.96 3.58 20.78 3 19.5 3c-1.28 0-2.46.58-3.44 1.56C15.08 5.54 14.5 6.72 14.5 8H13c0-1.28-.58-2.46-1.56-3.44C10.46 3.58 9.28 3 8 3c-1.28 0-2.46.58-3.44 1.56L3.5 3.5zM12 7c0 3.87-2.69 7.4-6.5 9.5L4.5 15C7.8 13.18 10 10.22 10 7h2zm0 0c0 3.22 2.2 6.18 5.5 8l-1 1.5C12.69 14.4 10 10.87 10 7h2z"/></svg> },
                  { name: 'Claude', svg: <svg viewBox="0 0 40 40" fill="none" width="40" height="40"><path d="M20 4C11.163 4 4 11.163 4 20s7.163 16 16 16 16-7.163 16-16S28.837 4 20 4zm-.5 6.5c.5-1.2 1.5-1.2 2 0l7 16.5c.4 1-.1 1.8-1.1 1.8h-2c-.7 0-1.2-.4-1.4-1l-1-2.8h-6l-1 2.8c-.2.6-.7 1-1.4 1h-2c-1 0-1.5-.8-1.1-1.8l7-16.5zm1 4.5-2 5.5h4l-2-5.5z" fill="white"/></svg> },
                  { name: 'Perplexity', svg: <svg viewBox="0 0 40 40" fill="none" width="40" height="40"><path d="M20 5L8 12.5V20l4-2.3V25H8v2h5v5h2v-5h10v5h2v-5h5v-2h-4v-7.3l4 2.3v-7.5L20 5zm0 2.6l9 5.2-9 5.2-9-5.2 9-5.2zM10 14.1l8 4.6V27H10v-7.7l-2-1.15v-2.88l2 1.13V14.1zm20 0v2.38l2-1.13v2.88L30 19.3V27H22v-8.3l8-4.6z" fill="white"/></svg> },
                  { name: 'Notion', svg: <svg viewBox="0 0 40 40" fill="none" width="40" height="40"><path d="M10 8.5c0-.9.5-1.4 1.6-1.5l14.8-1c1.8-.1 2.6.8 2.6 2.1v20.7c0 1.1-.4 1.9-1.8 2l-15.4 1c-1.2.1-1.8-.3-1.8-1.5V8.5zm3.5 1.2v19.1l12-0.8V10l-12 0.8-.1-.1zm2 2l8-.5v1.8l-8 .5v-1.8zm0 4l8-.5v1.8l-8 .5v-1.8zm0 4l5-.3v1.8l-5 .3v-1.8z" fill="white"/></svg> },
                ];
                const items = [...toolLogos, ...toolLogos];
                return (
                  <div style={{ position: 'relative', overflow: 'hidden', width: '100%' }}>
                    <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: '60px', background: 'linear-gradient(to right, #000000, transparent)', zIndex: 2, pointerEvents: 'none' }} />
                    <div style={{ position: 'absolute', right: 0, top: 0, bottom: 0, width: '60px', background: 'linear-gradient(to left, #000000, transparent)', zIndex: 2, pointerEvents: 'none' }} />
                    <div style={{ display: 'flex', gap: '3.5rem', width: 'max-content', animation: 'toolMarquee 30s linear infinite', alignItems: 'center', padding: '0.5rem 0' }}>
                      {items.map((tool, i) => (
                        <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.6rem', flexShrink: 0, opacity: 0.55, transition: 'opacity 0.25s ease, transform 0.25s ease', cursor: 'default', minWidth: '52px' }}
                        ...
                        >
                          {React.cloneElement(tool.svg, { width: 40, height: 40 })}
                          <span style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.5)', fontFamily: '"Archivo Black", sans-serif', letterSpacing: '0.08em', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>{tool.name}</span>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          <div style={{ minHeight: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', paddingTop: '3rem', paddingBottom: '2rem' }}>
            <div style={{ maxWidth: '900px', width: '100%', margin: '0 auto', padding: '0 1rem' }}>
              ...
              <div data-scroll-id="s41" style={{ ...scrollReveal('s41', null) }}>
                ...
                <GalleryFlipRow images={galleryImages} onExpand={setExpandedGalleryCard} expandedIndex={expandedGalleryCard?.index ?? null} onCollapse={() => { setIsGalleryClosing(true); setTimeout(() => { setExpandedGalleryCard(null); setIsGalleryClosing(false); }, 650); }} />
              </div>
            </div>
          </div>
        )}
      ...
      <style>{`
        ...
        *, *::before, *::after {
        ...
        @keyframes galleryCollapse {
          ...
          50% {
            transform: scale(0.7) translateY(15%) rotateY(90deg);
            opacity: 0.9;
          }
          100% {
            transform: scale(0.47) translateY(40vh) rotateY(180deg);
            opacity: 0;
          }
        }
        ...
        {expandedGalleryCard && (
          <div
            onClick={() => {
              ...
              setTimeout(() => { setExpandedGalleryCard(null); setIsGalleryClosing(false); }, 650);
            }}
            style={{
              position: 'absolute',
              top: 0, left: 0,
              ...
              animation: isGalleryClosing ? 'fadeOut 0.3s ease forwards' : 'fadeIn 0.3s ease forwards',
              cursor: 'zoom-out',
            }}
          >
            <div onClick={e => e.stopPropagation()} style={{ width: '720px', cursor: 'default', perspective: '1200px', transformStyle: 'preserve-3d', animation: isGalleryClosing ? 'galleryCollapse 0.6s cubic-bezier(0.4, 0, 0.8, 0.6) forwards' : 'galleryExpand 0.4s cubic-bezier(0.34, 1.2, 0.64, 1) forwards' }}>
