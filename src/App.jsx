  ...
  en: {
    ...
    gallery: {
      ...
      images: [
        ...
        { src: '/images/gallery/image3.jpg',   label: 'Creative Exchange', prompt: 'Two creatives at a vibrant networking event exchange digital business cards via NFC. Their smartphones touch, both showing blank white screens, while the bright, modern space buzzes with people networking in the background.', tools: ['Midjourney'] }, 
