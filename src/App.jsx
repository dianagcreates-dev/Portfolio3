...
const translations = {
  en: {
    ...
    gallery: {
      ...
      images: [
        { src: '/images/gallery/image1.1.jpg', label: 'Image 01', prompt: 'A high-fashion editorial portrait of a woman in a structured avant-garde outfit, dramatic studio lighting, deep shadows, hyper-detailed fabric texture, Vogue aesthetic, dark background, cinematic mood', tools: ['Midjourney v6', 'Adobe Lightroom'] },
