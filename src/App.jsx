    ...
    projects: [
      {
        ...
        content: {
          ...
          brandpackaging: "Because Palmi is designed for emotional support, the packaging should speak to children first. Its calm,friendly and non-technical,helping the children fel safe even before opening the product",
          metrics: [
    ...
    backgroundRepeat: 'no-repeat'
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  {selectedProject.content?.brandpackaging || "The purpose of this data is to support awareness and conversation. It is not meant to diagnose or assess, but to help parents better understand their child and seek professional support when needed."}
                </p>
